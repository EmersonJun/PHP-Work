...
<body>
    ...
    $events = [
        ...
        ["id" => 10, "titulo" => "Festival de Dança de Curitiba", "categoria" => "Dança", "descricao" => "Companhias de dança mostram seus espetáculos.", "imagem" => "./img/festivalDeDanca.jpg", "local" => "Teatro Guaíra", "data_hora" => "30 de Outubro", "preco" => "R$ 50,00", "contato" => "(41) 90000-0000", "link" => "#"],
        ...
        ["id" => 13, "titulo" => "Mostra de Arte Independente", "categoria" => "Arte", "descricao" => "Exibição de obras de artistas locais.", "imagem" => "./img/MostraDeArteIndependente.jpg", "local" => "Casa Hoffmann", "data_hora" => "5 de Dezembro", "preco" => "R$ 20,00", "contato" => "(41) 87777-7777", "link" => "#"],
        ["id" => 14, "titulo" => "Semana da Fotografia", "categoria" => "Fotografia", "descricao" => "Exposição de fotógrafos curitibanos.", "imagem" => "./img/semanaDaFotografia.jpg", "local" => "Museu da Fotografia", "data_hora" => "10 a 17 de Dezembro", "preco" => "Gratuito", "contato" => "(41) 86666-6666", "link" => "#"]
    ];
