...
<body>
    ...
    // Definição do array de eventos com suas informações
        $events =[
            ...
            ["id" => 5, "titulo" => "Festival de Jazz de Curitiba", "categoria" => "Música", "descricao" => "Os melhores músicos de jazz reunidos na cidade.", "imagem" => "./img/festivalJazz.jpg"],
            ["id" => 6, "titulo" => "Festival de Cinema da UFPR", "categoria" => "Cinema", "descricao" => "Mostra de curtas e longas universitários.", "imagem" => "./img/festivalCinema.jpg"],
            ["id" => 7, "titulo" => "Circuito de Arte Urbana", "categoria" => "Arte", "descricao" => "Intervenções artísticas nos muros da cidade.", "imagem" => "./img/circuitoArteUrbana.jpg"],
            ["id" => 8, "titulo" => "Bazar da Rua São Francisco", "categoria" => "Cultura", "descricao" => "Feira de artesanato e produtos autorais.", "imagem" => "./img/bazarSaoFancisco.jpg"],
            ["id" => 9, "titulo" => "Concerto na Capela Santa Maria", "categoria" => "Música", "descricao" => "Orquestra de câmara se apresenta em concerto.", "imagem" => "./img/concertoSM.jpg"],
